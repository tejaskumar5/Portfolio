  ...
  const projects = [
    {
      ...
      description: "A Calculator application to perform mathematical operations.",
    ...
    },
    {
      ...
      description: "A Backend application for Hotel management with user authentication.",
      link: "https://example.com",
      technologies: ["Java", "SpringBoot", "Oracle"],
    },
  ];
